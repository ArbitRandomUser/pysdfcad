...
# front row:
# The following are not true SDFs,
# the current oct-tree based mesh generation from
# marching-cubes-fast requires accurate sdf's
# for good mesh generation, there might be tiny holes
# in your stl. Even rendering these makes poor shadows.
# Should change this to regular
